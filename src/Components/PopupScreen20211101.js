...
export default class PopupScreen extends Component {
    ...
    checkItem = async(bool) => {      
      if ( bool ) {
          ...
          try {
              await AsyncStorage.setItem('isNoticePop20211101', ExpireDate2.toString());
          } catch (e) {
              console.log(e);
          }
      }else{
          await AsyncStorage.removeItem('isNoticePop20211101');
      }
                          ...
                          <ScrollView>
                            ...
                            <View style={{paddingTop:20,paddingHorizontal:20}}>
                              <CustomTextM style={{color:'#000000'}}>
                                착한부동산에서 제공하던 <CustomTextR style={{color:'#ff0000'}}>'오늘의 급매물'</CustomTextR> 서비스는 부득이한 사정으로 종료되었습니다.
                              </CustomTextM>
                            </View>
                            <View style={styles.lineHang}>
                              <CustomTextM style={{color:'#000000'}}>                                
                                현재 12월을 목표로 새로운 서비스(여러분이 원하는 모든 조건의 집을 찾아주는 서비스)를 개발하고 있습니다.
                              </CustomTextM>
                            </View>                            
                            <View style={styles.lineHang}>
                              <CustomTextM style={{color:'#000000'}}>
                                그리고 중개수수료 협의해주는 업체를 찾는 <CustomTextR style={{color:'#ff0000'}}>'착한중개인'</CustomTextR> 서비스를 하고 있으니 많이 이용바랍니다. 감사합니다.
                              </CustomTextM>
                            </View>
                          </ScrollView>
                        </View>
