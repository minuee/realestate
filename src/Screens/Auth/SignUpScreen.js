    ...
    render() {
        ...
        return(
            <SafeAreaView style={ styles.container }>
                ...
                <View style={[styles.commonFlex2,{minHeight:SCREEN_HEIGHT*0.1}]}>
                    <View style={styles.topMenuWrap}>
                        <View style={{padding:5,borderBottomColor:DEFAULT_COLOR.base_color,borderBottomWidth:2}}>
                            <CustomTextB style={[CommonStyle.textSize12,CommonStyle.fontColorBase]}>로그인</CustomTextB>
                        </View>
                        <TouchableOpacity 
                            hitSlop={{left:10,right:10,bottom:10,top:10}}
                            style={{padding:5}} onPress={()=> this.joinMember()}
                        >
                            <CustomTextL style={[CommonStyle.textSize12,CommonStyle.fontColorDefault]}>회원가입</CustomTextL>
                        </TouchableOpacity>
                        <TouchableOpacity 
                            hitSlop={{left:10,right:10,bottom:10,top:10}}
                            style={{padding:5}} 
                            onPress={()=>this.props.navigation.navigate('PWResetStack')}
                        >
                            <CustomTextL style={[CommonStyle.textSize12,CommonStyle.fontColorDefault]}>비밀번호찾기</CustomTextL>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={styles.commonFlex2}>
                    <View style={{flex:1}}>
                        <CustomTextL style={[CommonStyle.textSize16,CommonStyle.fontColorDefault]}>
                            내 주변의 중개수수료
                        </CustomTextL>
                        <CustomTextL style={[CommonStyle.textSize16,CommonStyle.fontColorDefault]}>
                            할인해주는 착한중개인 찾기
                ...
                <View style={styles.fixedBottom} >
                    <CustomTextR style={[CommonStyle.textSize13,CommonStyle.fontColorBase]}>가입없이 사용해 보기</CustomTextR>
                </View>
                <TouchableOpacity style={styles.fixedBottomBall} onPress={()=>this.nonUserLogin()}>
                    <Image source={require('../../../assets/icons/btn_guest.png')} resizeMode={"contain"} style={{width:CommonUtil.dpToSize(70),height:CommonUtil.dpToSize(70)}} />
                </TouchableOpacity>
                </>
                }
