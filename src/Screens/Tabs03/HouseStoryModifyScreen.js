...
class HouseStoryModifyScreen extends Component {
    ...
    async UNSAFE_componentWillMount() {
        if ( CommonUtil.isEmpty(this.props.extraData.params.estate_story_pk)) {
            ...
            //console.log('this.props.extraData.params.screenData error1',this.props.extraData.params.screenData);
    ...
    actionRegist = async() => {
        ...
        try {
            returnCode = await apiObject.API_HouseStoryModify({
                locale: "ko",
...
export default connect(mapStateToProps,null)(HouseStoryModifyScreen);