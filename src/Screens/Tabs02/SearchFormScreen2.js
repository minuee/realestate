...
class SearchFormScreen2 extends Component {
    constructor(props) {
        super(props);
    ...
    async UNSAFE_componentWillMount() {
        let myKeywordHistory = await AsyncStorage.getItem('MyKeywordHistory2');
        //console.log('myKeywordHistory', myKeywordHistory);
    ...
    getSearchResult = async() => {
        if ( CommonUtil.isEmpty(this.state.searchKeyword))  {
            ...
            await AsyncStorage.setItem('MyKeywordHistory2', JSON.stringify(newReturnArray2));
            //여기서부터 검색
    ...
    moreDataUpdate = async( baseData , addData) => {     
        ...
        //console.log('defaultArray222222',defaultArray);
    ...
    getInformation = async ( currentpage,morePage = false,searchKeyword) => {
        ...
        //console.log('filterData',moment().format('YYYY-MM-DD'));
        ...
        try {
            ...
            returnCode = await apiObject.API_fastRentData({
                locale: "ko",
                Sdate :  '',
                area_sido : '',
                page : currentpage,
    ...
    actionRemove = async(item) => {
        ...
        await AsyncStorage.setItem('MyKeywordHistory2', JSON.stringify(returnArray));
        setTimeout(
            () => {            
                this.setState({
                    moreLoading:false,
                    myKeywordHistory : returnArray
                })
            },500
        )
    }
                        ...
                        <View style={styles.mainWrap}>
                            <View style={styles.defaultResultWrap2}> 
                                <View style={styles.tdTitleWrap}>
                                    ...
                                    <View style={styles.tdTitleFlex1}>
                                    <CustomTextL style={[CommonStyle.textSize12,CommonStyle.fontColor222]}>급전세</CustomTextL>
                                    </View>
                                ...
                                <View style={{flex:1}}>
                                    ...
                                    >
                                    {
                                        ...
                                        //console.log('this.props.isApartBookMark',this.props.isApartBookMark)
                                        return (
                                            <TouchableOpacity key={index} onPress={()=>this.moveNavigation(item)} style={styles.dataTitleWrap}>
                                                ...
                                                <View style={styles.tdTitleFlex1}>
                                                    <CustomTextL style={[CommonStyle.textSize12,CommonStyle.fontColor222]}>
                                                        <TextRobotoM style={[CommonStyle.textSize17,CommonStyle.fontColor222]}>{CommonFunction.convertMillionComma(item.trade_avg_price)}</TextRobotoM>억
                                                    </CustomTextL>  
                                                </View>
                                                <View style={styles.tdTitleFlex1}>
...
export default connect(mapStateToProps,mapDispatchToProps)(SearchFormScreen2);