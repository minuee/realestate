...
import {Alert,SafeAreaView,ScrollView,TouchableOpacity, View,StyleSheet,Image,Dimensions,ActivityIndicator,BackHandler,Linking,PixelRatio,Platform} from 'react-native';
                        ...
                        <View style={styles.defaultResultWrap}> 
                            <View style={styles.tdTitleWrap}>
                                <View style={styles.tdTitleFlex22}>
                                    ...
                                    >
                                        <Tooltip popover={this.renderTooltip()} width={SCREEN_WIDTH*0.8} height={100} backgroundColor="#f7f7f7" >
                                        ...
                                        <TouchableOpacity key={index} onPress={()=>this.moveNavigation(item)} style={styles.dataTitleWrap}>
                                            ...
                                            <View style={styles.tdTitleFlex1}>
                                                <CustomTextL style={[CommonStyle.textSize12,CommonStyle.fontColor222]}>
                                                    <TextRobotoM style={[CommonStyle.textSize17,CommonStyle.fontColor222]}>{CommonFunction.convertMillionComma(item.fast_deal.trade_avg_price)}</TextRobotoM>억
                                                </CustomTextL>
                                            </View>
                                            <View style={styles.tdTitleFlex1}>
