...
const DEFAULT_latitudeDelta = 0.02;//뒤에 숫자가 커질수록 축소 0.0922*30   0.04:동
...
const baseSigunguZoomMaker = Platform.OS === 'ios' ? 12 : 12;
const baseEupmyeonZoomMaker = Platform.OS === 'ios' ? 14 : 14;
*/
const baseClusterZoomMaker = 5;
const baseSidoZoomMaker = 9;
const baseSigunguZoomMaker = Platform.OS === 'ios' ? 11 : 11;
...
class IntroScreen extends React.Component {
    ...
    async UNSAFE_componentWillMount() {
        //console.log('this.props.mainMapViewTarget',this.props.mainMapViewTarget)
        SplashScreen.hide();    
    ...
    onRegionChangeComplete = async(region) => {       
        ...
        //console.log('markerNowFocus',markerNowFocus)
        ...
        if ( baseZoom > baseEupmyeonZoomMaker ) { // 매물 view Articles
            ...
            */
            ...
            if ( markerNowFocus !== 'eupmyeon' && showMaemul) {
            ...
            }else if ( markerNowFocus !== 'eupmyeon' && showAgent) {
                this.setState({
                    markerNowFocus : 'eupmyeon'
                }) 
                this.setUpdatePermision();
            ...
            */
            ...
            if ( markerNowFocus != 'sigungu') {
                ...
                if ( showMaemul ) { 
                    this.setUpdatePermision();
                }else if ( markerNowFocus !== 'sigungu' && showAgent) {
                    this.setState({markerNowFocus : 'sigungu'}) 
                    this.setUpdatePermision();
                }
            }
            */
            ...
            if ( markerNowFocus != 'sido') {
                ...
                if ( showMaemul ) {
                    this.setUpdatePermision();
                }else if ( markerNowFocus !== 'sido' && showAgent) {
                    this.setState({markerNowFocus : 'sido'}) 
                    this.setUpdatePermision();
                }
            }
                ...
                return (
                    <>
                    {
                        ...
                        markerDataArticle.map((marker,index) => (
                            <Marker
                                ...
                                onPress={() => this.moveDetail(marker)}
                            >
                                <MapArticleMarker {...marker} stopTrackingViewChanges={this.stopTrackingViewChanges} />
                            </Marker>                
                        ))
                        :
                        null
                    ...
                    markerDataAgent.map((marker,index) => (
                        ...
                        >
                            <MapAgentMarker 
                                {...marker} 
                                //stopTrackingViewChanges={this.stopTrackingViewChanges}
                            />
                        </Marker>                
                    ))
                    }
                ...
                <View style={ styles.container }>                    
                    ...
                    <View style={{flex:1}}> 
                        <MapView
                            ...
                            enableZoomControl={!this.state.moreLoading}
                            showsMyLocationButton={false}
                            pitchEnabled={!this.state.moreLoading} 
                            rotateEnabled={!this.state.moreLoading} 
                            zoomEnabled={!this.state.moreLoading}
                            scrollEnabled={!this.state.moreLoading}
                            initialRegion={{
                                latitude: this.state.currentLatitude,
                                longitude: this.state.currentLongitude,
                                latitudeDelta: this.state.latitudeDelta,
                        ...
                        */}
                        ...
                        {this.state.markerNowFocus === 'article1' &&
